...
> ⁺ CNN/RNN metrics sourced from original Google Colab training.
...
<br>
1 · TextBlob vs VADER Score Correlation
Validates that both sentiment tools agree on review polarity direction.

TextBlob vs VADER

<br>
2 · Sentiment Category Distribution
Reveals the significant class imbalance — 94% of reviews are Positive.

Sentiment Distribution

<br>
3 · Algorithm Performance Comparison
All 5 models benchmarked across Accuracy, Precision, Recall and F1-Score.
Y-axis starts at 0.0 for honest comparison.

Model Comparison

<br>
4 · Random Forest Learning Curve
Shows training vs validation loss as dataset size increases.
Confirms the model generalises well and is not overfitting.
...
Statistics	scipy	1.10+	One-Way ANOVA testing
NLP	nltk + vaderSentiment	3.8+	Rule-based sentiment scoring
NLP	textblob	0.17+	Lexicon-based sentiment + subjectivity
ML	scikit-learn	1.3+	Classifiers · Vectorizer · GridSearchCV
Deep Learning	tensorflow / keras	2.13+	SimpleRNN and Conv1D models
Visualization	matplotlib	3.7+	All chart generation
Visualization	seaborn	0.12+	Enhanced scatter plot styling
